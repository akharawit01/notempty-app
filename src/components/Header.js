                ...
                <div id="header-container" className="container navbar-container">
                    ...
                    <div id="navbar" className="collapse navbar-collapse">
                        <ul className="nav navbar-nav navbar-right">
                            <li role="Why Notemptysoft"><a href="#section02">Why Notemptysoft</a></li>
                            <li role="About Us Notemptysoft"><a href="">About Us</a></li>
                            <li role="Services Notemptysoft"><a href="">Services</a></li>
                            <li role="Contact Us Notemptysoft"><a href="">Contact Us</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
